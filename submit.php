...
if(!empty($_POST['stripeToken'])){
    ...
    //set api key
    $stripe = array(
      "secret_key"      => "sk_test_emnOsXYtHuPwvg61prALflGF00xEIIHjZX",
      "publishable_key" => "pk_test_910FpFUUvSFr8mSmt1XGfHwE00kd5e7LXs"
    );
    ...
    if($chargeJson['amount_refunded'] == 0 && empty($chargeJson['failure_code']) && $chargeJson['paid'] == 1 && $chargeJson['captured'] == 1){
        ...
        if($last_insert_id && $status == 'succeeded'){
            ...
            $msg="Amount debited="+$msg;
            mail($email,"Transaction is successful",$msg);
        }else{
